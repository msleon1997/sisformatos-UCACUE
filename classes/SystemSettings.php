...
class SystemSettings extends DBConnection
{
	...
	function obtenerIdActividadPracticaPre()
	{
		// Realiza una consulta SQL para obtener el ID de actividades_practicas_pre
		$sql = "SELECT Actividades_practicas_pre_id FROM cronograma_actividades WHERE tu_condicion = tu_valor";
		$resultado = $this->conn->query($sql);

		// Verifica si la consulta fue exitosa
		if ($resultado) {
			// Obtiene el ID de actividades_practicas_pre del resultado
			$row = $resultado->fetch_assoc();
			$idActividadPracticaPre = $row['Actividades_practicas_pre_id'];
			return $idActividadPracticaPre;
		} else {
			// Si la consulta falla, devuelve null o realiza algún manejo de errores
			return null;
		}
	}
