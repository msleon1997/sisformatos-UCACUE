        ...
        <div class="modal-dialog modal-md modal-dialog-centered rounded-0" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-default border btn-flat" data-dismiss="modal">Cerrar</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="modal-dialog modal-md modal-dialog-centered rounded-0" role="document">
          <div class="modal-content rounded-0">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-default border btn-flat" data-dismiss="modal">Cancelar</button>
            </div>
          </div>
        </div>
      </div>
