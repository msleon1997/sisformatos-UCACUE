...
(function () {
    ...
    var SearchPane = /** @class */ (function () {
        ...
        SearchPane.prototype._getComparisonRows = function () {
            ...
            var tableVals = this.s.dt.rows({ Buscar: 'applied' }).data().toArray();
            var appRows = this.s.dt.rows({ Buscar: 'applied' });
        ...
        SearchPane.prototype._populatePane = function (last) {
            ...
            if (!this.s.dt.page.info().serverSide) {
                var indexArray = (this.c.cascadePanes || this.c.viewTotal) && (!this.s.clearing && !last) ?
                    table.rows({ Buscar: 'applied' }).indexes() :
                    table.rows().indexes();
            ...
            if (!this.s.dt.page.info().serverSide &&
                ...
                if (this.colExists) {
                    ...
                    //  there is a need to update certain parts ofthe rowData.
                        ...
                        && this.s.dt.rows().data().toArray().length === this.s.dt.rows({ Buscar: 'applied' }).data().toArray().length) {
    ...
    var SearchPanes = /** @class */ (function () {
        ...
        SearchPanes.prototype.redrawPanes = function (rebuild) {
            ...
            if (!this.s.updating && !this.s.dt.page.info().serverSide) {
                ...
                if (table.rows({ buscar: 'applied' }).data().toArray().length === table.rows().data().toArray().length) {
                    filterActive = false;
                }
